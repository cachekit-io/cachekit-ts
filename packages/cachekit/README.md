...
| CachekitIO (SaaS) | `cachekitio` from `@cachekit-io/cachekit`                   | Node, edge | fetch-based; TTL + locking variants; TTL must be 1..2,592,000 s (30 days) — `0`/negative/larger throw `ConfigurationError` per the protocol spec |
