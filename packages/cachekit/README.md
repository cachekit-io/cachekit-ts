...
an envelope that declares more than `maxDecodedSize` is rejected before it is
unpacked, so the core codec never allocates for it. Size it against your runtime's
